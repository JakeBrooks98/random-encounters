...
export const WelcomePage = () => {
    return <div class="welcomeMessage">
        ...
        <br/>
        <p>Start your adventure now by <Link to={`/Encounters`}>choosing from a list of our users encounters</Link> or test your party's strength against the Random Encounters! 
